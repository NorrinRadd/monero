...
* ```make depends target=x86_64-apple-darwin11``` for macOS binaries.
  * Requires: `cmake imagemagick libcap-dev librsvg2-bin libz-dev libbz2-dev libtiff-tools python-dev autotools-dev automake python3 bsdmainutils curl ca-certificates unzip ccache python3-setuptools-git libtinfo5`
